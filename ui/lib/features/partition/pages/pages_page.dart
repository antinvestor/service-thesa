...
class _PageDetail extends StatelessWidget {
  const _PageDetail({required this.page});

  final PageObject page;

  @override
  Widget build(BuildContext context) {
    final createdAt = page.hasCreatedAt()
        ? DateFormat.yMd().format(page.createdAt.toDateTime())
        : 'N/A';

    final htmlPreview = page.html.length > 200
        ? '${page.html.substring(0, 200)}...'
        : page.html;
